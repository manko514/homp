...
const links = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8 22H16" /><path d="M9 3h6l-3 9-3-9z" />
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
        ...
        <div>
          <p className="text-white font-bold text-sm leading-tight tracking-wide">HOMP</p>
        ...
        {links.map(({ href, label, icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className="flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium transition-all relative group"
              style={{
      ...
      {/* Divider */}
      <div className="mx-4 my-3" style={{ height: 1, backgroundColor: 'rgba(255,255,255,0.08)' }} />
